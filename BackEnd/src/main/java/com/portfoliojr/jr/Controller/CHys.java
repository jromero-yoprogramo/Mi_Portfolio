...
public class CHys {
    ...
    public ResponseEntity<?> create(@RequestBody dtoHys dtohys) {
        ...
        return new ResponseEntity(new Mensaje("Se agregó una nueva skill"), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoHys dtohys) {
        ...
        if (shys.existsByNombre(dtohys.getNombre()) && shys.getByNombre(dtohys.getNombre()).get().getId() != id) {
            return new ResponseEntity(new Mensaje("Esa skill ya esiste"), HttpStatus.BAD_REQUEST);
        }
        ...
        shys.save(hYs);
        return new ResponseEntity(new Mensaje("La skill se ha actualizado"), HttpStatus.OK);
    }
